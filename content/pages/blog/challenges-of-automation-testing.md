...
date: '2022-04-12'
excerpt: >-
  Challenges testers face on a daily with end-to-end testing and tips on how to
  overcome them.
featuredImage:
  type: ImageBlock
...
---
I think its save to say that in todays world, client and stakeholder expect software application they use everyday to provide them with rick experiences. The days of simple applications with a few form fields and store basic data are gone. We love in a world where we have real-time applications with nice designs and multiple services stores on the cloud

Because of this applications can become very complex with a lot of moving parts. With this, testing has also become much more complex, with multiple pieces of functionality working in different and stores in different locations.
...
Some teams perform these complex tests manually, going through each step to cover their acceptance criteria. As mentioned earlier, this process take time and this can lead to tiredness and mistake set to creep in and even can rush to tick all the boxes on the acceptance criteria and just forget to their work, however more and more businesses are now leveraging the power of automation testing to free them from doing the same stuff over and over again.
...
End-to-end testing doest consist of a lot of moving parts and needs to validate different components through a test run, it is difficult to isolate whats causing the issue. This inconsistency leads to a lot of lost time trying to figure out the root cause of the flakiness since it’s nearly impossible to replicate the failing scenario. And worse of all, flaky tests leads to teams to accepting them, ignoring potential issues and decreasing the value of automation tests.
